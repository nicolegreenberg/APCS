...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener
{
  ...
  private void setUpNextAndPreviousButtons()
  {
    ...
    Icon prevIcon = new ImageIcon(DigitalPicture.class.getResource("best-kitten-names-1.gif"), 
                                  "previous index");
    Icon nextIcon = new ImageIcon(DigitalPicture.class.getResource("best-kitten-names-1.gif"), 
                                  "next index");
  ...
  {
    Picture pix = new Picture("best-kitten-names-1.jpg");
    pix.explore();
  }
